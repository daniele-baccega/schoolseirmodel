    ...
    [
      ...
      if day = 0
        [ file-print (word "day\tseedRun\tsusceptible\texposed\tinfected\tremoved\t"
                      ...
                      "num-infected-outside\tclassroom-in-quarantine\tnum-of-classroom-in-quarantine\tclassroom-with-at-least-one-infected\tprob-outside-contagion") ]
      ...
      file-type num-infected-outside file-type "\t" file-type classrooms-in-quarantine file-type "\t" file-type length classrooms-in-quarantine file-type "\t"
      file-type prob-outside-contagion file-type "\t" 
      file-print classroom-with-at-least-one-infected
