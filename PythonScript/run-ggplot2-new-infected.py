...
def main():
	if len(sys.argv) < 7:
		print("Error, parameters are missing: python run-ggplot2-new-infected.py path policy day_name vaccinated_students_% num_traces type_of_screening [type_of_screening ...]")
		exit()
