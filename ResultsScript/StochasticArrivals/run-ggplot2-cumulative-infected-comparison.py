...
def main():
	...
	paths.append(Path(__file__).parent / ("../../mean-results/" + long_path + "/WithCountermeasures/WithoutScreening/mean_WithoutScreening.csv"))
	paths.append(Path(__file__).parent / ("../../mean-results/" + long_path + "/WithoutCountermeasures/WithoutScreening/mean_WithoutScreening.csv"))
