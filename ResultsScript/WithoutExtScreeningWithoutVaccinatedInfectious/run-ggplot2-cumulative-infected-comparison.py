...
def main():
	...
	my_plot.save('../../plot-ggplot2/' + long_path + '/WithCountermeasures/WithoutVaccinatedInfectious/ComparisonWithAndWithoutCountermeasures/plot_cumulative-infected-comparison', dpi=600)
	df_plot.to_csv('../../plot-ggplot2/' + long_path + '/WithCountermeasures/WithoutVaccinatedInfectious/ComparisonWithAndWithoutCountermeasures/plot-file/plot_cumulative-infected-comparison.csv')
main();
