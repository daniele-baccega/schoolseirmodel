...
to accumulate-aerosol [room]
  ...
  let infected-students count turtles with [ breed = students and infected? and room-name = room ]
  let infected-teachers count turtles with [ breed = teachers and infected? and room-name = room ]
  let infected-principal count turtles with [ breed = principals and infected? and room-name = room ]
  let infected-janitors count turtles with [ breed = janitors and infected? and room-name = room ]
  let has-people 0
  ...
  let base-n-r-students-vaccinated ((activity-type-students * ngen-base) / (10 ^ vl)) * virus-variant-factor
  let base-n-r-students-in-gym-vaccinated ((activity-type-students-in-gym * ngen-base) / (10 ^ vl)) * virus-variant-factor
  let base-n-r-teachers-vaccinated ((activity-type-teachers * ngen-base) / (10 ^ vl)) * virus-variant-factor
  let base-n-r-teachers-in-classroom-vaccinated ((activity-type-teachers-in-classroom * ngen-base) / (10 ^ vl)) * virus-variant-factor
  let base-n-r-principals-vaccinated ((activity-type-principals * ngen-base) / (10 ^ vl)) * virus-variant-factor
  let base-n-r-janitors-vaccinated ((activity-type-janitors * ngen-base) / (10 ^ vl)) * virus-variant-factor
  ...
  let total-n-r n-r-students * infected-students + n-r-teachers-in-classroom * infected-teachers + n-r-principals * infected-principal + n-r-janitors * infected-janitors

  if room = "TR"
    [
      set volume teachers-room-volume
      set total-n-r n-r-students * infected-students + n-r-teachers * infected-teachers + n-r-principals * infected-principal + n-r-janitors * infected-janitors
    ]
  ...
  if room = "G"
    [
      ...
      set total-n-r n-r-students-in-gym * infected-students + n-r-teachers * infected-teachers + n-r-principals * infected-principal + n-r-janitors * infected-janitors
    ]
